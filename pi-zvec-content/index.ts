...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    description: "Search contents of a project-relative file or directory and return bounded excerpts. Use paths from download_file or find. Use words, phrases, or natural-language concepts; intentional regex-like queries are handled as regex. This is the content-reading tool—do not try read_file, read, bash, or grep.",
    promptSnippet: "Use file_content_search—not read/read_file/grep/bash—to inspect local file contents; use paths from download_file or find.",
