...
5. Concurrent searches against the same target are serialized.
6. Regex-like queries use zvec managed ripgrep; other queries use hybrid indexed retrieval.
7. zvec process failures are real Pi tool errors and include bounded path-redacted diagnostics.
